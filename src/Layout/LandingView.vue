<template>
  <div class=" py-[60px] h-[100vh] max-[1200px]:h-fit">
    <div
      ...
      >
        <div>
          <div class="mb-[51px] max-[576px]:mb-[20px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="85" height="46" viewBox="0 0 85 46" fill="none">
              <path
                  d="M66.7613 25.3388C66.7613 21.5337 64.587 21.1992 64.3779 21.1992V21.1156H72.448V41.2698C72.448 45.0331 74.5805 45.4094 74.8314 45.4094V45.4512H64.3779V45.4094C64.587 45.4094 66.7613 45.0331 66.7613 41.2698V25.3388ZM66.3014 15.638C66.3014 13.9236 67.723 12.502 69.4374 12.502C71.1518 12.502 72.5734 13.9236 72.5734 15.638C72.5734 17.3524 71.1518 18.774 69.4374 18.774C67.723 18.774 66.3014 17.3524 66.3014 15.638Z"
                  fill="#F04D00"/>
              <path
                  d="M51.7194 45.451V45.4092C51.9702 45.4092 54.1027 45.0329 54.1027 41.2696V16.1814C54.1027 12.4181 51.9702 12.0418 51.7194 12.0418V12H59.7894V41.2696C59.7894 45.0329 61.9637 45.4092 62.1728 45.4092V45.451H51.7194Z"
                  fill="#F04D00"/>
              <path
                  d="M38.1724 45.9107C30.0605 45.9107 26.2136 40.0568 26.2136 33.3248C26.2136 26.5509 30.0605 20.697 38.1724 20.697C46.2842 20.697 50.1311 26.5509 50.1311 33.3248C50.1311 40.0568 46.2842 45.9107 38.1724 45.9107ZM32.0676 33.3248C32.0676 39.8477 34.1164 45.0326 38.1724 45.0326C42.2701 45.0326 44.3608 39.8477 44.3608 33.3248C44.3608 26.8018 42.2701 21.6169 38.1724 21.6169C34.1164 21.6169 32.0676 26.8018 32.0676 33.3248Z"
                  fill="#F04D00"/>
              <path
                  d="M9.82624 45.4509V45.4091C10.0771 45.4091 12.2933 45.0328 12.2933 41.1023L12.3351 32.2378L4.43226 17.2684C2.55064 13.6306 0.33451 12.9198 0 12.9198V12.8362H10.4953V12.878C10.4534 12.878 8.69727 13.5052 10.2862 16.5158L17.4363 30.2307L24.252 16.9339C25.9664 13.5888 24.0011 12.878 23.9175 12.878V12.8362H30.0223V12.9198C29.5623 12.9198 26.8863 13.7143 24.8792 17.6866L18.0636 30.9415V41.1023C18.0636 45.0328 20.3215 45.4091 20.5306 45.4091V45.4509H9.82624Z"
                  fill="#F04D00"/>
              <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd"
                    d="M81.8902 19.8888C81.9019 20.1257 82.0931 20.3157 82.3301 20.3259C83.8655 20.3918 85.0001 20.6241 85.0001 20.9005C85.0001 21.177 83.8655 21.4093 82.3301 21.4752C82.0931 21.4854 81.9019 21.6754 81.8902 21.9123C81.8176 23.3857 81.5903 24.4608 81.3212 24.4608C81.0514 24.4608 80.8236 23.3802 80.7516 21.901C80.7401 21.666 80.5521 21.4768 80.3171 21.4638C78.901 21.3854 77.8796 21.1629 77.8796 20.9005C77.8796 20.6382 78.901 20.4156 80.3171 20.3373C80.5521 20.3243 80.7401 20.135 80.7516 19.9C80.8236 18.4208 81.0514 17.3403 81.3212 17.3403C81.5903 17.3403 81.8176 18.4154 81.8902 19.8888Z"
                    fill="#F04D00"/>
              <path opacity="0.7" fill-rule="evenodd" clip-rule="evenodd"
                    d="M65.8103 2.60629C65.8227 2.84318 66.0135 3.03298 66.2505 3.04389C67.5672 3.10453 68.5341 3.30564 68.5341 3.54438C68.5341 3.78313 67.5672 3.98423 66.2505 4.04487C66.0135 4.05578 65.8227 4.24558 65.8103 4.48247C65.744 5.74452 65.5473 6.65957 65.3151 6.65957C65.0821 6.65957 64.8851 5.73943 64.8193 4.47195C64.8071 4.23699 64.6191 4.04804 64.3842 4.03426C63.1724 3.96316 62.3037 3.77069 62.3037 3.54438C62.3037 3.31808 63.1724 3.1256 64.3842 3.05451C64.6191 3.04073 64.8071 2.85177 64.8193 2.61681C64.8851 1.34934 65.0821 0.429199 65.3151 0.429199C65.5473 0.429199 65.744 1.34425 65.8103 2.60629Z"
                    fill="#F04D00"/>
            </svg>
          </div>
          <h3
              class="text-[60px] mb-[16px] font-[700] w-[440px] font-beauty
                     max-[1440px]:text-[40px] max-[576px]:text-[24px] max-[576px]:w-fit"
          >
            Your personal yoga coach,
            in your palm
          </h3>
          <p class="text-[#8A8A8A] text-[16px] mb-[32px]">Your Ultimate Companion for Yoga & Fitness</p>
          <button
              class="bg-[#F04D00] text-white py-[13px] px-[16px] text-[16px] font-[600] leading-[22px]
                   rounded-[32px] shadow-[0_4px_8px_0_rgba(240,77,0,0.2)] w-[166px] hover:opacity-[0.9] ease-in-out duration-300"
          >
            Tải ứng dụng
          </button>
        </div>
        <div class="flex items-between flex-col gap-[40px]">
          <div class="flex gap-[12px] items-center">
            <img src="../assets/img/avatar-group.png" alt="">
            <span class="text-[#202020] font-[500] text-[14px]">1000+ user Yoli world wide</span>
          </div>
          <div class="flex gap-[16px]">
            <span class="font-[500] text-[14px] text-[#8A8A8A]">Terms</span>
            <span class="font-[500] text-[14px] text-[#8A8A8A]">Privacy</span>
            <span class="font-[500] text-[14px] text-[#8A8A8A]">Copyright 2024 YOLI. All rights reserved</span>
          </div>
        </div>
      </div>
      <div
...
import bgBotSlider1 from '../assets/img/bg-bot-slider-1.png'
import imgBotSlider1 from '../assets/img/img-bot-slider-1.jpg'
...
import iphoneSlider2 from '../assets/img/ip2.png'
import iconLayout from '../assets/img/iconLayout.png'
import iconYoga from '../assets/img/iconYoga.png'
